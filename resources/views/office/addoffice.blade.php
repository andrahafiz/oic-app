                        ...
                        <div class="item-wrapper">
                            <form method="post" action="{{ route('office.store') }}">
                                ...
                                <div class="form-group row showcase_row_area">
                                    ...
                                    <div class="col-md-8 showcase_content_area">
                                        <input type="number" class="form-control @error('inp_jumlah') is-invalid @enderror"
                                ...
                                <div class="form-group row showcase_row_area">
                                    ...
                                    <div class="col-md-8 showcase_content_area">
                                        <input type="text" class="form-control @error('inp_satuan') is-invalid @enderror"
                                ...
                                <div class="form-group row showcase_row_area">
                                    ...
                                    <div class="col-md-8 showcase_content_area">
                                        <input type="number" class="form-control @error('inp_total') is-invalid @enderror"
                                            id="inp_total" name="inp_total" placeholder="Masukan jumlah">
                                        @error('inp_total')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group row showcase_row_area">
                                    ...
                                    <div class="col-md-8 showcase_content_area">
                                        <input type="text"
                                            class="form-control @error('inp_lokasi') is-invalid @enderror" id="inp_lokasi"
                                            name="inp_lokasi" placeholder="Masukan data lokasi"
...
@push('scripts')
    <script>
        $(document).on("change", "#inp_jumlah", function() {
            var jumlah = $(this).val();
            var harga = $('#inp_harga').val();
            $("#inp_total").val(harga * jumlah);
        });
    </script>
@endpush
